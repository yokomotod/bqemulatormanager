...
class TestBigquery(unittest.TestCase):
    def test_query(self):
        ...
        use_df = pd.DataFrame(
            [
                {"code": "0111", "service_id": 0},
                {"code": "0111", "service_id": 1},
                {"code": "0222", "service_id": 0},
            ]
        )
        ...
        expected_df = pd.DataFrame(
            [
                {"code": "0111", "service_name": "service-A"},
                {"code": "0111", "service_name": "service-B"},
                {"code": "0222", "service_name": "service-A"},
                {"code": "0333", "service_name": "service-C"},
            ]
        )
